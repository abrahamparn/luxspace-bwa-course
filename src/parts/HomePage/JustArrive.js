      ...
      <div className="flex -mx-4 flex-row relative">
        ...
        <div className="px-4 relative card group">
          ...
          >
            ...
            <img src="assets/images/content/image-arrived-3.png" alt=""className="w-full h-full object-cover object-center"/>
          </div>
        ...
        <div className="px-4 relative card group">
          <div className="rounded-xl overflow-hidden card-shadow relative" style={{width: 287, height: 386}}>
            ...
            <img src="assets/images/content/image-arrived-4.png" alt="" className="w-full h-full object-cover object-center"/>
          </div>
        ...
        <div className="px-4 relative card group">
          <div className="rounded-xl overflow-hidden card-shadow relative" style={{width: 287, height: 386}}>
            ...
            <img src="assets/images/content/image-arrived-5.png"alt="" className="w-full h-full object-cover object-center"/>
          </div>
        ...
        <div className="px-4 relative card group">
          <div className="rounded-xl overflow-hidden card-shadow relative" style={{width: 287, height: 386}}>
            ...
            <img src="assets/images/content/image-arrived-1.png" alt="" className="w-full h-full object-cover object-center"/>
          </div>
          <h5 className="text-lg font-semibold mt-4">Racking Plants</h5>
          <span className="">IDR 599.400</span>
          <a href="#details.html" className="stretched-link"></a>
